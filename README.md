...
Google Colab is a service that allows you to run and work on Jupyter 
in the cloud. 
* If you do not have a local Jupyter Notebook installation (next section below) then use Google Colab
...
Each notebook has a button at the top which says Open in Colab. Click this to start a Colab session for that notebook.
